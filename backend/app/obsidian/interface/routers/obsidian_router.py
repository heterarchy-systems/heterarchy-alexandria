...
from app.obsidian.interface.routers.obsidian_vault_maintenance_router import (
    router as vault_maintenance_router,
)
...
router.include_router(vault_maintenance_router)
